          ...
          <div className="row gy-4">
              ...
              <div className="portfolio-details-slider swiper">
                <div className="swiper-wrapper align-items-center">
                  <div className="swiper-slide">
                    <picture>
                      <source srcSet="assets/img/Aypinautomat/pim1.webp" type="image/webp" />
                      <img
                        src="assets/img/Aypinautomat/pim1.webp"
                        alt={t("Özel Üretim Pimler")}
                        title={t("Özel Üretim Pimler")}
                        loading="lazy"
                        decoding="async"
            ...
            <div className="col-lg-7">
              <div className="portfolio-description p-0">
                <h2 style={{ color: "#0000FF", textAlign: "center" }}>{t("Özel Üretim Pimler")}</h2>
